...
\begin{frame}{OpenDataDetector}
  \centering
  \only<1>{\includegraphics[width=0.7\textwidth]{assets/odd_glam.png}}
  \only<2>{\includegraphics[width=0.7\textwidth]{assets/odd_layout.pdf}}
  \only<3>{\includegraphics[width=0.7\textwidth]{assets/odd_tracker.pdf}}
\end{frame}
...
\begin{frame}{Particle properties}
  \centering
  \resizebox{!}{\textheight-4em}{\includesvg{gist/figures/particle_eta.svg}}
\end{frame}

\begin{frame}{Particle properties}
  \centering
  \resizebox{!}{\textheight-4em}{\includesvg{gist/figures/particles_pt.svg}}
\end{frame}


\begin{frame}{Vertex properties}
  \centering
  \resizebox{0.5\textwidth}{!}{\includesvg{gist/figures/vertices_vz.svg}}%
  \resizebox{0.5\textwidth}{!}{\includesvg{gist/figures/vertices_vy.svg}}
\end{frame}
...
\begin{frame}{Simulated particle properties}
  \centering
  \resizebox{0.5\textwidth}{!}{\includesvg{gist/figures/sim_ptcl_pt.svg}}%
  \includegraphics[width=0.5\textwidth]{gist/figures/sim_ptcl_nhits.pdf}
\end{frame}

\begin{frame}{Simulated particle properties (cont.)}
  \centering
  \includegraphics[width=0.5\textwidth]{gist/figures/sim_ptcl_x0.pdf}%
  \includegraphics[width=0.5\textwidth]{gist/figures/sim_ptcl_l0.pdf}
\end{frame}

\begin{frame}{Simulated particle properties (cont.)}
  \centering
  \includegraphics[height=\textheight-3em]{gist/figures/hits_rz.png}%
\end{frame}
...
\begin{frame}{Cluster properties}
  \centering
  \includegraphics[width=0.5\textwidth]{gist/figures/cluster_loc0.pdf}%
  \includegraphics[width=0.5\textwidth]{gist/figures/cluster_loc1.pdf}
  \begin{itemize}
...
\begin{frame}{Seed properties}
  \centering
  \includegraphics[width=0.5\textwidth]{gist/figures/seed_phi.pdf}%
  \includegraphics[width=0.5\textwidth]{gist/figures/seed_eff_eta.pdf}
\end{frame}
...
\begin{frame}{CKF outputs (cont.)}
  \centering
  \includegraphics[width=0.5\textwidth]{gist/figures/track_eff_eta.pdf}%
  \includegraphics[width=0.5\textwidth]{gist/figures/track_nmeas.pdf}
\end{frame}
...
\begin{frame}{Vertex properties}
  \centering
  \includegraphics[width=0.5\textwidth]{gist/figures/vertex_count.pdf}%
  \includegraphics[width=0.5\textwidth]{gist/figures/vertex_resz.pdf}
\end{frame}
